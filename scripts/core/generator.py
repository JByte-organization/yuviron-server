# =============================================================================
# scripts/core/generator.py — Главная функция генерации конфигурации.
#
# run_generate_config() — точка входа. Принимает параметры (env, domain, apps,
# extra_routes) и генерирует все файлы в generated/<env>/.
#
# Алгоритм:
#   1. Загрузить config/apps.yml и config/routes.yml
#   2. Определить выбранные приложения (selected_keys)
#   3. Вычислить все маршруты (_resolve_routes):
#      - Маршрут client (корневой домен или subdomain)
#      - Маршрут api (backend:5073)
#      - Маршруты из routes.yml, отфильтрованные по env
#      - Extra-маршруты из --extra-routes
#   4. Слить env-файлы и stack_values в deploy.env
#   5. Сгенерировать htpasswd (если не существует)
#   6. Записать все выходные файлы
#   7. Вычислить SHA-256 хэши всех источников и выходных файлов → manifest.env
#
# manifest.env используется preflight для проверки "свежести" конфига.
# =============================================================================
