...
if __package__ in {None, ""}:
    ...
    raise SystemExit(subprocess.call([str(cli_path), "backup", *sys.argv[1:]]))
...
def _wait_for_mysql_ready(context: object, mysql_root_password: str, timeout_seconds: int, logger: BackupLogger) -> None:
    start_ts = time.time()
...
def cmd_backup_create(args: argparse.Namespace) -> int:
    ...
    from .backup.operations import register as register_backup
